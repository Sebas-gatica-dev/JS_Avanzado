...
var isAncestor = function(genealogyTree, ancestor, descendant){
  // Tu código aca:
  var abuela = ancestor;
     for(var key in genealogyTree){
        if(genealogyTree[key].includes(descendant)){
              var count = key;     
        } 
    }
       
    if(genealogyTree[abuela].includes(count)){
             return true;
    } else if(!genealogyTree[abuela].includes(count)){
               return false;
    }
...
LinkedList.prototype.switchPos = function (pos1, pos2) {
  ...
  if (pos1 > this.size() || pos2 > this.size() || pos1 < 0 || pos2 < 0) return false;
    ...
    // En caso de switch: variable auxiiares...
  }
};
...
LinkedList.prototype.switchPos = function(pos1, pos2) {
  ...
  var previoNode1 = null
  var previoNode2 = null
  var node1 = this.head;
  var node2 = this.head;
  ...
  if (previoNode1 != null)
  previoNode1.next = node2;
  else
  this.head = node2;

  if (previoNode2 != null)
  previoNode2.next = node1;
  else
  this.head = node1;
